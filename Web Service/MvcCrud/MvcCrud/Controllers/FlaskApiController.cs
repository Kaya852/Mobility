...
{
    public class FlaskApiController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString)
        {
            try
            {
                ...
                var response = await client.GetAsync("http://localhost:5000/api/Records/list");
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Surname,Age")] Record record)
        {
            ...
            {
                var client = _clientFactory.CreateClient();
                var response = await client.PostAsJsonAsync("http://localhost:5000/api/Records/add", record);
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            {
                var client = _clientFactory.CreateClient();
                var response = await client.DeleteAsync($"http://localhost:5000/api/Records/delete/{id}");
